package com.fast.dev.push.factory;
...
import com.fast.dev.push.conf.MongodbConfig;
...
public class MongodbFactory {
	 ...
	 * @return
	 */
	public static MongoDbFactory mongoDbFactory(MongodbConfig mongodbConfig) {
		// 数据库账号
	 ...
	 * @return
	 */
	public static GridFsTemplate gridFsTemplate(MongoDbFactory mongoDbFactory) {
	...
	public static MongoTemplate mongoTemplate(MongoDbFactory mongoDbFactory) {
