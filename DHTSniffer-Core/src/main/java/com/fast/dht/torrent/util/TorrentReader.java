...
import com.fast.dht.torrent.bcodec.BDecoder;
import com.fast.dht.torrent.bcodec.BEValue;
import com.fast.dht.torrent.bcodec.BEncoder;
...
public class TorrentReader {
	 ...
	 * @throws IOException
	 *             When the info dictionary can't be read or encoded and hashed back
	 ...
	 *            <tt>.torrent</tt> file to load.
	 * @param seeder
	 *            Whether we are a seeder for this torrent or not (disables local
	 *            data validation).
	 * @throws IOException
	 *             When the torrent file cannot be read.
	 */
	 ...
	 *
	 * @param parent
	 *            The parent directory or location of the torrent files, also used
	 ...
	 *            The file to use in the torrent.
	 * @param announceList
	 *            The announce URIs organized as tiers that will be used for this
	 *            torrent
	 * @param createdBy
	 *            The creator's name, or any string identifying the torrent's
	 *            creator.
